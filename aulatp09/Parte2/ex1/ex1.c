/* 1. A rotina de serviço à interrupção implementada no exercício 6 apenas transfere para a
UART um carater, cada vez que é executada. O procedimento de transmissão pode,
contudo, ser melhorado, se se copiar mais do que 1 carater diminuindo, desse modo, o
overhead resultante do processo de interrupção. Nesse sentido, altere a rotina de serviço à
interrupção de transmissão de modo a copiar para a UART2 todos os carateres do buffer
circular de transmissão ou copiar até o FIFO da UART2 ficar cheio – a situação limite é a
que ocorrer em primeiro lugar. Faça os testes que lhe permitam averiguar que as alterações
efetuadas funcionam como pretendido.*/
